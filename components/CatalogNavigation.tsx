      ...
      <div className="container-luxury">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Wishlist */}
            <button
              className="p-2 text-gray-600 hover:text-gray-800 transition-colors duration-300 relative"
              onClick={() => {
                if (wishlistItemCount !== 0) {
                  onSetCategorie('wishlist')
                }
              }}
            >
              <Heart
                className="w-5 h-5"
                color={categorie === 'wishlist' ? 'red' : 'black'}
              />
